...
const CameraScreen = () => {
    ...
    /*Função para dar permissão para a câmera*/
    useEffect(() => {
        (async () => {
        ...
        <View style={styles.container}>
            {
                ...
                (
                    ...
                    (
                        ...
                        >
                            <View 
                                style={{flex:1, with:'100%', backgroundColor:'transparent', flexDirection:'row'}}>
                                <View 
                                    style={{position:'absolute', left:'5%', top:'10%', flexDirection:'column', justifyContent:'space-between'}}
                                >
                                    <TouchableOpacity 
                                        onPress={ativarFlash}
                                        style={{borderRadius:50, height:25, width:25, backgroundColor: flashAtivado==='off'?'#000':'#FFF'}}
                                    >
                            ...
                            >
                                <View style={{flex:1, flexDirection:'column', padding:15, justifyContent:'flex-end'}}>
                                    <View style={{flexDirection:'row', justifyContent:'space-between'}}>
                                        <TouchableOpacity onPress={tirarOutraFoto} style={{width:130, height:40, alignItems:'center', backgroundColor:'white'}}>
                                            <Text>Tirar Outra</Text>
                                        </TouchableOpacity>

                                        <TouchableOpacity onPress={salvarFoto} style={{width:130, height:40, alignItems:'center', backgroundColor:'blue'}}>
                                            <Text>Salvar</Text>
                                        </TouchableOpacity>
                                    </View>
                                </View>
